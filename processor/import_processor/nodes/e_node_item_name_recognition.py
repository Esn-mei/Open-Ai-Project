...
class NodeItemNameRecognition(BaseNode):
    ...
    def process(self, state: ImportGraphState) -> ImportGraphState:
        ...
        backup_path = r"D:\Agent\output\联想至像大象系列打印机用户手册V1\auto\联想至像大象系列打印机用户手册V1_new_new_chunks.json"
...
if __name__ == "__main__":
    ...
    md_path = r"D:\Agent\output\联想至像大象系列打印机用户手册V1\auto\联想至像大象系列打印机用户手册V1_new_chunks.json"
